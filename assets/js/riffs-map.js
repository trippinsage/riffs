...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!select || !mapDiv || !infoDiv || !loadingDiv) {
    return;
  }
  ...
  if (typeof L === "undefined") {
    loadingDiv.className = "map-load-error";
    loadingDiv.textContent = "The interactive map is unavailable. Choose a store above or use the full location list below.";
